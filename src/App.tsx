...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#081326] text-white flex justify-center">
      ...
      <main className="w-full max-w-[440px] min-h-screen relative z-10 bg-gradient-to-b from-[#0d1d3b] via-[#0a162e] to-[#071124] border-x border-[#ff5500]/15 shadow-[0_0_80px_rgba(4,10,24,0.95)] flex flex-col overflow-hidden">
        ...
        {/* Divider accent */}
        <div className="w-full h-[1px] bg-gradient-to-r from-transparent via-[#ff5500]/25 to-transparent my-2" />
