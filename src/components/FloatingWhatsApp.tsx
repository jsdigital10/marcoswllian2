  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          aria-hidden="true"
          className="absolute top-1 left-2.5 right-2.5 h-3 rounded-full bg-gradient-to-b from-white/35 to-transparent pointer-events-none"
        />

        {/* Official 3D-styled WhatsApp SVG icon */}
        <svg
          className="w-7 h-7 fill-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.4)] transition-transform group-hover:scale-105"
          viewBox="0 0 24 24"
