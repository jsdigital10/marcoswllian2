...
export const MODALITIES: ModalityOption[] = [
  {
    id: 'corrida',
    title: 'CORRIDA',
    actionText: 'Falar sobre Corrida',
    iconName: 'timer',
    whatsappMessage: 'Olá Marcos Willian! Gostaria de falar sobre corrida.',
  },
  {
    id: 'musculacao',
    title: 'MUSCULAÇÃO',
    actionText: 'Falar sobre Musculação',
    iconName: 'dumbbell',
    whatsappMessage: 'Olá Marcos Willian! Gostaria de falar sobre musculação.',
  },
  {
    id: 'presencial',
    title: 'PRESENCIAL',
    actionText: 'Falar sobre Presencial',
    iconName: 'mapPin',
    whatsappMessage: 'Olá Marcos Willian! Gostaria de falar sobre o atendimento presencial.',
  },
  {
    id: 'online',
    title: 'ONLINE',
    actionText: 'Falar sobre Online',
    iconName: 'globe',
    whatsappMessage: 'Olá Marcos Willian! Gostaria de falar sobre a consultoria online.',
  },
  {
    id: 'hibrido',
    title: 'TREINO HÍBRIDO',
    actionText: 'Falar sobre Treino Híbrido',
    iconName: 'zap',
